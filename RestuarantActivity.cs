...
{
    [Activity(Label = "Restuarants")]
    public class RestuarantActivity : Activity
    {
        ...
        {
            MenuInflater.Inflate(Resource.Menu.Restuarant_Menu, menu);
        ...
        public override bool OnOptionsItemSelected(Android.Views.IMenuItem item)
        {
            switch (item.ItemId)
            {
                case Resource.Id.products_id:
                    var intent = new Intent(this, typeof(ProductActivity));
                    StartActivity(intent);
                    return true;
                case Resource.Id.profile_id:
                    var intents = new Intent(this, typeof(UpdateActivity));
                    StartActivity(intents);
                    return true;
                case Resource.Id.logout_id:
                    var inten = new Intent(this, typeof(RestuarantActivity));
                    StartActivity(inten);
                    return true;
                default:
                    return false;
